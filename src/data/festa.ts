...
export const features: { title: string; text: string; soon?: boolean }[] = [
  ...
  {
    title: "სტუმრების სია — ლაივ რეჟიმში",
    text: "სტუმრები ონლაინ ადასტურებენ დასწრებას, პასუხები კი ავტომატურად ერთ ფაილში იყრის თავს — სრულ სიას რეალურ დროში ხედავთ.",
  },
  {
...
export const faqs = [
  ...
  },
  {
    ...
    a: "მზა დიზაინი ჩვეულებრივ 1 სამუშაო დღეში, ინდივიდუალურის დასამზადებლად 2–3 დღე გვჭირდება.",
  },
  {
    q: "შეიძლება თუ არა ტექსტისა და ფოტოების შეცვლა?",
    a: "დიახ, არჩეული დიზაინის შემთხვევაში შეგვიძლია შევცვალოთ ტექსტი, ფოტოები და ფერები.",
  },
  {
